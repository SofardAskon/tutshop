    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Значения фильтра "{{ $filter->name }}"</h1>
                    </div><!-- /.col -->
                    <a href="{{ route('filter.values.create', $filter->id) }}" class="btn btn-primary mb-3">Добавить значение</a>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                            ...
                            <tbody>
                                @foreach ($filterValues as $value)
                                    <tr class="odd">
                                        ...
                                        <td>{{ $value->value }}</td>
                                        <td> <a href="{{ route('values.edit', $value->id) }}" class="btn btn-sm btn-warning">Редактировать</a> </td>
                                    </tr>
                                @endforeach
                            </tbody>
                            <tfoot>
